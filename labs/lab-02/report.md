...
#####  - gitk window:  
  ![gitk window](Images/gitk-out.jpg)   
#####  - git log command line output:
  ![git log output](Images/cl-out-git-log.jpg)
...
![Learn Git Branching Introduction Seqeuence Completion](Images/IntroSequenceFinished.jpg)
...
##### - 'git diff' output:  
   ![git diff output](Images/git-diff-output.jpg)   

##### - 'git tag -l' output
![git tag -l output](Images/git-tag-l-out.jpg)  
